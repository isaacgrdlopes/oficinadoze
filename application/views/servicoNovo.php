<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br>
            <form id="form" class="form-horizontal form-label-left" method="POST" action="/servicos/salvarNovo">
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input data-mask="00/00/0000" type='text' id="dataentrega" name='dataentrega' class="form-control col-md-7 col-xs-12 ">
                    </div>
                </div>
                <div class="form-group">
